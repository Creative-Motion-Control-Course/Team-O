...
AnalogInput amplitude_slider_a2;

// -- Slider to control frequency -- //
AnalogInput frequency_slider_a3;
...
void setup() {
 ...
 // Set the speed (start at zero, use Serial commands to change it, or change the value in code)
  ...
  // -- Configure the amplitude slider -- //
  amplitude_slider_a2.begin(IO_A2);
  amplitude_slider_a2.set_floor(0);
  amplitude_slider_a2.set_ceiling(10);
  amplitude_slider_a2.set_deadband(1, 509, 4); // deadband controls designated range where input movements do not produce output change to avoid jitter.
  amplitude_slider_a2.map(&y_wave_gen.amplitude); // map the value of the slider to the scaling filter ratio.

    // -- Configure the frequency slider -- //
  frequency_slider_a3.begin(IO_A3);
  frequency_slider_a3.set_floor(0);
  frequency_slider_a3.set_ceiling(10);
  frequency_slider_a3.set_deadband(1, 509, 4); // deadband controls designated range where input movements do not produce output change to avoid jitter.
  frequency_slider_a3.map(&y_wave_gen.frequency); // map the value of the slider to the scaling filter ratio.
